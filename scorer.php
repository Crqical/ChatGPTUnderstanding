...
<section id="contact">
    <div class="inner">
        <div class="field half">
            ...
            <input type="text" name="url" id="name" value="<?= isset($_GET['id']) ? $_GET['id'] : '' ?>" />
        </div>
    </div>
    <ul class="actions">
        <li>
            <form action="https://docs.google.com/document/d/<?= isset($_GET['id']) ? $_GET['id'] : '' ?>/edit" target="_blank">
